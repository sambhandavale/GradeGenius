...
Future<Map<String, dynamic>> createDoubt(Map<String, dynamic> data) async {
  try {
    final apiService = ApiService(Constants.secureStorage,authRequired: true);
    final response = await apiService.postRequest('/kaksha/doubt/create-doubt', data);
    return {
    ...
    if (e is ApiException) {
      ...
      debugPrint('Error creating Doubt: ${e.statusCode}');
      return {
      ...
      debugPrint('Error during creating Doubt: $e');
      return {
        'statusCode': 500,
