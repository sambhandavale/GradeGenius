...
Future<Map<String, dynamic>> createKaksha(Map<String, dynamic> data) async {
  try {
    final apiService = ApiService(Constants.secureStorage,authRequired: true);
    final response = await apiService.postRequest('/kaksha/create-kaksha', data);
    return {
    ...
    if (e is ApiException) {
      ...
      debugPrint('Error during creating kaksha: ${e.statusCode}');
      return {
      ...
      debugPrint('Error during creating kaksha: $e');
      return {
        'statusCode': 500,
